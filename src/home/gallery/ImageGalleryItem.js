...
import { OPENING_ANIMATION_IN_PROGRESS, OPEN_AND_IDLE, DRAG_IN_PROGRESS } from "./ImageGalleryConstants";
...
class ImageGalleryItem extends React.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        ...
        return !shallowEqualsIgnoreKeys(this.props, nextProps, keysToIgnore) || !shallowEquals(this.state, nextState);
    }
    ...
    _renderImage() {
        let { activeItemIndex, index, initialItem, item, lifecycle, width } = this.props;
...
export default connect((data) => ImageGalleryItem.getDataProps(data))(ImageGalleryItem);
